...
namespace WebUI.Helpers
{
    public class ContentEditorBuilder : IHtmlString
    {
        ...
        public class ContentEditorWidget
        {
            ...
            public string Name => _builder._name;
            public string Mnemonic => _builder._mnemonic;
            public MvcHtmlString TitleTemplate => _builder._titleTemplate;
            public string Template => _builder._template;
            public string Wrap => _builder._wrap;
            public string Extender => string.IsNullOrEmpty(_builder._extender) ? "{}" : _builder._extender;
            public object Model => _model ?? (_model = _builder._modelType.With(Activator.CreateInstance));
            public string Title => _builder._title;
        }
    }
