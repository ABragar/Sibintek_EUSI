...
(function () {
	...
	function angularMoment(angular, moment) {
		 ...
		 */
             ...
             * @function
             */
            .filter('amAsWord', ['moment', 'amMoment', 'angularMomentConfig', function (moment, amMoment, angularMomentConfig) {
                function amAsWord(value, format, format1) {
                    if (isUndefinedOrNull(value)) {
                        return '';
                    }

                    if (isUndefinedOrNull(format1)) {
                        format1 = format;
                    }

                    var date = moment(value, format);// amMoment.preprocessDate(value);
                ...
                amAsWord.$stateful = angularMomentConfig.statefulFilters;
