            ...
            foreach (var editor in editors)
            {
                if (editor.PropertyType == typeof(string) && (editor.PropertyDataTypeName == "String" || editor.PropertyDataTypeName == "MultilineText" || editor.PropertyDataTypeName == "Text"))
                {
                    result.Add(GetQueryFilterVm(editor.PropertyName, editor.Title, QueryBuilderType.STRING, editor.PropertyDataTypeName,
                        new List<QueryBuilderOperator>() { QueryBuilderOperator.equal, QueryBuilderOperator.not_equal, QueryBuilderOperator.contains, QueryBuilderOperator.not_contains, QueryBuilderOperator.is_null, QueryBuilderOperator.is_not_null, QueryBuilderOperator.@in }));
                }
                else if (editor.PropertyType == typeof(int) && editor.PropertyDataTypeName == "Integer" || editor.PropertyDataTypeName == "Number")
                {
                    result.Add(GetQueryFilterVm(editor.PropertyName, editor.Title, QueryBuilderType.INTEGER, editor.PropertyDataTypeName,
                        new List<QueryBuilderOperator>() { QueryBuilderOperator.equal, QueryBuilderOperator.not_equal, QueryBuilderOperator.less, QueryBuilderOperator.less_or_equal, QueryBuilderOperator.greater, QueryBuilderOperator.greater_or_equal, QueryBuilderOperator.@in }));
                }
                else if (editor.PropertyType == typeof(int?) && editor.PropertyDataTypeName == "Integer" || editor.PropertyDataTypeName == "Number")
                {
                    result.Add(GetQueryFilterVm(editor.PropertyName, editor.Title, QueryBuilderType.INTEGER, editor.PropertyDataTypeName,
                        new List<QueryBuilderOperator>() { QueryBuilderOperator.equal, QueryBuilderOperator.not_equal, QueryBuilderOperator.less, QueryBuilderOperator.less_or_equal, QueryBuilderOperator.greater, QueryBuilderOperator.greater_or_equal, QueryBuilderOperator.is_null, QueryBuilderOperator.is_not_null, QueryBuilderOperator.@in }));
                }
                ...
                else if (editor.PropertyType == typeof(DateTime))
                {
                    ...
                    if (editor.PropertyDataTypeName == Enum.GetName(typeof(PropertyDataType), PropertyDataType.Date))
                    {
                        result.Add(GetQueryFilterVm(editor.PropertyName, editor.Title, QueryBuilderType.DATE, editor.PropertyDataTypeName,
                            new List<QueryBuilderOperator>() { QueryBuilderOperator.equal, QueryBuilderOperator.not_equal, QueryBuilderOperator.less, QueryBuilderOperator.less_or_equal, QueryBuilderOperator.greater, QueryBuilderOperator.greater_or_equal, QueryBuilderOperator.@in, QueryBuilderOperator.between, QueryBuilderOperator.not_between }));
                    }
                }
                else if (editor.PropertyType == typeof(DateTime?))
                {
                    ...
                    {
                        result.Add(GetQueryFilterVm(editor.PropertyName, editor.Title, QueryBuilderType.DATE, editor.PropertyDataTypeName,
                            new List<QueryBuilderOperator>() { QueryBuilderOperator.equal, QueryBuilderOperator.not_equal, QueryBuilderOperator.less, QueryBuilderOperator.less_or_equal, QueryBuilderOperator.greater, QueryBuilderOperator.greater_or_equal, QueryBuilderOperator.is_null, QueryBuilderOperator.is_not_null, QueryBuilderOperator.@in, QueryBuilderOperator.between, QueryBuilderOperator.not_between }));
                    }
                }
                ...
                else if (editor.PropertyType.IsEnum)
                {
                    ...
                    result.Add(GetQueryFilterVm(editor.PropertyName, editor.Title,
                        ...
                        new List<QueryBuilderOperator>() { QueryBuilderOperator.equal, QueryBuilderOperator.is_null, QueryBuilderOperator.is_not_null, QueryBuilderOperator.@in }, additional_info));
                }
                //TODO: 
