...
var WrapToolbar = WrapWidget.extend({
    ...
    initCustomCommands: function (paramCommands) {
        ...
        for (i = commands.length; i--;) {
            ...
            var actionSelector = '[data-command-id=' + command.id + ']';

            $el = this.element().find(actionSelector);
            ...
            this.visible(actionSelector, true);
        ...
        var $commands = this.element().find('.custom-commands');
