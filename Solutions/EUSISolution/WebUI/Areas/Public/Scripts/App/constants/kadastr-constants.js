(function (window, angular) {
    angular.module('MapApp')
        .constant('KAD_CARTOGRAM_TYPES', {
            1: 'Цифровые топокарты',
            2: 'Ортофотопланы',
            3: 'Ортофотопокрытия'
        })
        .constant('KAD_AREA_TYPES', {
