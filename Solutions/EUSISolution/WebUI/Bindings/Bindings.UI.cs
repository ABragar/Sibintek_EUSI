...
namespace WebUI.Bindings
{
    public class UiBindings
    {
        ...
        public static void Bind(Container container)
        {
            ...
            container.Register<IQueryTreeFilter, QueryTreeFilter>(Lifestyle.Singleton);
            container.RegisterSingleton(new QueryTreeServiceOptions()
            {
                UserType = typeof(User)
            });
            container.Register<IQueryTreeService, QueryTreeService>(Lifestyle.Singleton);
