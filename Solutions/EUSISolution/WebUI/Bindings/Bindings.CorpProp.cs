...
namespace WebUI.Bindings
{
    public class CorpPropBindings
    {
        public static void Bind(Container container)
        {
            ...
            container.Register<ISocietyCalculatedFieldService, SocietyCalculatedFieldService>();
            ...
            container.Register<ISibEmailService, SibEmailService>();
            ...
            container.Register(typeof(IGetAllService<>), typeof(GetAllService<>), Lifestyle.Singleton);
            ...
            #region Active Directory Integration
            container.Register<CorpProp.WindowsAuth.Initializer>();
            container.Register<IADUserService, ADUserService>();
            container.Register<IAccessUserWizardService<ADUserWizard>, ADUserWizardService>();
            #endregion
