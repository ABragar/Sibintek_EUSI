(function () {
    ...
    gridFilters.baseObjectColumn = function (params) {
        ...
        var url = URI.expand('/api/{controller}/{mnemonic}/filter/baseObject',
            {
                controller: wrapGrid.transport.read.controller,
            ...
            transport: {
                read: {
                    ...
                    data: function () {
                        ...
                        $.extend(data, wrapGrid.transport.read.data);
   ...
   gridFilters.stringColumn = function (wrapGrid, property, $element) {
        ...
        var url = URI.expand('/api/{controller}/{mnemonic}/filter/string',
            {
                controller: wrapGrid.transport.read.controller,
                mnemonic: wrapGrid.mnemonic
            });
