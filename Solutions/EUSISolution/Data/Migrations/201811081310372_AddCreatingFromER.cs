namespace Data.EF
{
    ...
    public partial class AddCreatingFromER : DbMigration
    {
        public override void Up()
        {
            AddColumn("[CorpProp.Accounting].AccountingObjectTbl", "CreatingFromER", c => c.Int());
            AddColumn("[CorpProp.Accounting].AccountingObjectTbl", "CreatingFromERPosition", c => c.Int());
            AlterOSView();
        }
        
        public override void Down()
        {           
            DropColumn("[CorpProp.Accounting].AccountingObjectTbl", "CreatingFromERPosition");
            DropColumn("[CorpProp.Accounting].AccountingObjectTbl", "CreatingFromER");
        }
