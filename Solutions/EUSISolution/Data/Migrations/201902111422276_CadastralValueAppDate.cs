namespace Data.EF
{
    ...
    public partial class CadastralValueAppDate : DbMigration
    {
        public override void Up()
        {
            AddColumn("[CorpProp.Accounting].AccountingObjectTbl", "CadastralValueAppDate", c => c.DateTime());
            Sql(@"
            IF OBJECT_ID(N'[CorpProp.Accounting].[AccountingObject]') IS NOT NULL 
...
, [CadastralValueAppDate] = obu.[CadastralValueAppDate]
...
, [LessorSubjectID] = obu.[LessorSubjectID]
...
, [ProprietorSubjectID] = obu.[ProprietorSubjectID]
...
, [RightRegEndDate] = obu.[RightRegEndDate]
...
, tbl.[CadastralValueAppDate] = obu.[CadastralValueAppDate]
...
, tbl.[RightRegEndDate] = obu.[RightRegEndDate]
...
GO
            ...
            Sql(@"
            IF OBJECT_ID(N'[EUSI.Accounting].[AccountingObjectExtView]') IS NOT NULL 
...
-- Modify date: 21.06.2018
-- Description:	Триггер на вставку/обновление ОБУ
-- =============================================  
CREATE TRIGGER [EUSI.Accounting].[TR_AccountingObjectExtView_Upd] on [EUSI.Accounting].[AccountingObjectExtView]
INSTEAD OF UPDATE
AS
BEGIN
	
MERGE INTO [CorpProp.Accounting].[AccountingObject] tbl
   USING ( SELECT * FROM inserted) obu
   ON (tbl.ID = obu.ID)
   WHEN MATCHED THEN 
	UPDATE 
...
-- Description:	Триггер на вставку/обновление ОБУ
-- =============================================  
create TRIGGER [EUSI.Accounting].[TR_AccountingObjectExtView_Ins] ON [EUSI.Accounting].[AccountingObjectExtView]
   INSTEAD OF INSERT
AS 
BEGIN
	INSERT INTO [CorpProp.Accounting].[AccountingObject] (
  [AccountingStatusID]  
, [AccountLedgerLUS]
, [AccountNumber]
, [AccumulatedDepreciationRSBU] 
...
END
            ...
            DropColumn("[CorpProp.Accounting].AccountingObjectTbl", "CadastralValueAppDate");
        }
    }
}
