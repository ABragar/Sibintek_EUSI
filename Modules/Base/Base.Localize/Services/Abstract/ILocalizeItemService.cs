...
namespace Base.Localize.Services.Abstract
{
    public interface ILocalizeItemService : IBaseCategorizedItemService<LocalizeItem>
    {
        ...
        string GetValueByKey<TObject, TProperty>(TObject obj, Func<TObject, TProperty> property, string lang) where TProperty : class;
        LocalizePairString GetLocalizePairString<TObject, TProperty>(TObject obj, Expression<Func<TObject, TProperty>> property, string lang) where TProperty : class;
