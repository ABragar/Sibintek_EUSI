...
namespace Base.DAL
{
    public interface IObjectSaver<TEntity> where TEntity : IBaseObject
    {
        bool IsNew { get; }
        ...
        /// <returns></returns>
        IObjectSaver<TObject> AsObjectSaver<TObject>(bool copySrcToDest = true) where TObject : BaseObject;
        ...
        IObjectSaver<TEntity> SaveManyToMany<TEntry>(Expression<Func<TEntity, ICollection<TEntry>>> property)
        ...
        /// <param name="property">Many to Many navigation property</param>
        /// <returns>ObjectSaver for chain support</returns>
        IObjectSaver<TEntity> SaveOneToMany<TEntry>(Expression<Func<TEntity, ICollection<TEntry>>> property)
            where TEntry : BaseObject;
