...
namespace Data
{
    internal static class PresetsInitializer
    {
        ...
        {
            CreateAdminMenu(unitOfWork, presetRegistorService, presets);
            CreateUserMenu(unitOfWork, presetRegistorService, presets);
       ...
       IDictionary<string, ICollection<PresetRegistor>> presets)
        {
            ...
            var menuPreset = CorpProp.DefaultData.MenuDefaultData.CreateAdminMenu();
        ...
        public static void CreateUserMenu(IUnitOfWork unitOfWork, IPresetRegistorService presetRegistorService,
           IDictionary<string, ICollection<PresetRegistor>> presets)
        {
            var menuPreset = CorpProp.DefaultData.MenuDefaultData.CreateUserMenu();
