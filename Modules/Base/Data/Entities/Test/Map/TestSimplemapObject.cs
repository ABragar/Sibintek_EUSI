...
namespace Data.Entities.Test.Map
{
    ...
    public class TestSimpleMapObject : BaseObject, IGeoObject
    {
        ...
        public ICollection<TestEasy> Easy { get; set; }


        [DetailView(Name = "Many", Order = 1), ListView]
        public ICollection<TestBaseMapObject> Many { get; set; }

        [DetailView(Name = "Ref", Order = 1), ListView]
        public TestBaseMapObject Ref { get; set; }
    }
