...
(function(root, factory) {
  ...
  .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle', function($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
    ...
    var Slider = function(scope, sliderElem) {
       ...
       */
      this.range = angular.isDefined(this.scope.rzSliderModel) && angular.isDefined(this.scope.rzSliderHigh);
    ...
    Slider.prototype = {
      ...
      resetLabelsValue: function() {
        delete this.minLab.rzsv;
        delete this.maxLab.rzsv;
      },
      ...
      translateFn: function(value, label, which, useCustomTr) {
        useCustomTr = !angular.isDefined(useCustomTr) ? true : useCustomTr;
  ...
  .directive('rzslider', ['RzSlider', function(RzSlider) {
    ...
    return {
      ...
      link: function (scope, elem) {
          ...
          scope.rzSliderModel = angular.isDefined(scope.rzSliderModel) ?
              scope.rzSliderModel :
              (angular.isDefined(scope.rzSliderOptions) ?
                (angular.isDefined(scope.rzSliderOptions.floor) ? scope.rzSliderOptions.floor :
                (angular.isDefined(scope.rzSliderOptions.ceil) ? scope.rzSliderOptions.ceil : 0))
                : 0);

          scope.rzSliderHigh = angular.isDefined(scope.rzSliderHigh) ?
              scope.rzSliderHigh :
              (angular.isDefined(scope.rzSliderOptions) ?
                (angular.isDefined(scope.rzSliderOptions.ceil) ? scope.rzSliderOptions.ceil :
                (angular.isDefined(scope.rzSliderOptions.floor) ? scope.rzSliderOptions.floor : 0))
                : 0);
