(function ($, pba_api) {
    ...
    proxyclient.corpProp = {
        ...
        createScheduleStateRegistrationRecords: proxyclient.create_func("{+base_uri}/corpProp/createScheduleStateRegistrationRecords/{itemsIds}/{elementId}/{isAccountingObject}{?_}", { method: "POST" }, null, "&"),
        createScheduleStateTerminateRecords: proxyclient.create_func("{+base_uri}/corpProp/createScheduleStateTerminateRecords/{itemsIds}/{elementId}/{isAccountingObject}{?_}", { method: "POST" }, null, "&"),
