...
(function () {
    ...
    corpProp.dv.wnd.openWnd = function (mnemonic) {
        ...
        //if (!corpProp.dv.wnd.testWnd(mnemonic, 0))
        //    return;
    ...
    corpProp.dv.wnd.delWnd = function (mnemonic, id) {
        var storage = sessionStorage.getItem("openedObjects");
        var openedObjects = JSON.parse(storage) || [];
        ...
        var data = $.grep(openedObjects, function (o) {
            return o.Order !== item.Order || (o.Mnemonic !== item.Mnemonic && o.AlterMnemonic !== item.AlterMnemonic) || o.Id !== item.Id;
        })
    ...
    corpProp.dv.wnd.setTabIndex = function (form, tabIndex) {
        ...
        var data = [];
        var item = openedObjects.find(function (o) {
            return (o.Mnemonic === dialog.mnemonic || o.AlterMnemonic !== dialog.mnemonic) && o.Id === dialog.params.currentID && o.Order === openedObjects.length
        });
