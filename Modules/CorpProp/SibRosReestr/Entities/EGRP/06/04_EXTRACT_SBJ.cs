namespace SibRosReestr.EGRP.V06.ExtractSubj
{
    using System;
    ...
    {
        /// <summary>
        /// РЈРЅРёРєР°Р»СЊРЅС‹Р№ РёРґРµРЅС‚РёС„РёРєР°С‚РѕСЂ РґРѕРєСѓРјРµРЅС‚Р°
        /// </summary>
        [XmlElement(Order = 0)]
    ...
    public class TOpenRegistration
    {
        ...
        public string RegDate { get; set; }
        /// <summary>
        /// РРЅС„РѕСЂРјР°С†РёСЏ Рѕ РІРѕСЃСЃС‚Р°РЅРѕРІР»РµРЅРёРё РїСЂР°РІР° РїРѕ СЂРµС€РµРЅРёСЋ СЃСѓРґР°
        /// </summary>
        [XmlElement(Order = 6)]
        public string RestorCourt { get; set; }
        /// <summary>
        /// РќРѕРјРµСЂ РїСЂРµРєСЂР°С‰РµРЅРёСЏ (РїРµСЂРµС…РѕРґР°) РїСЂР°РІР°
        /// </summary>
        [XmlElement(Order = 7)]
        ...
        [XmlElement("Share", typeof(TOpenRegistrationShare), Order = 9)]
        [XmlElement("ShareText", typeof(string), Order = 9)]
        public object Item { get; set; }
        /// <summary>
        /// Р”РѕРєСѓРјРµРЅС‚С‹ - РѕСЃРЅРѕРІР°РЅРёСЏ СЂРµРіРёСЃС‚СЂР°С†РёРё РїСЂР°РІР°
        /// </summary>
        [XmlElement("DocFound", Order = 10)]
        public List<TDocRight> DocFound { get; set; }
