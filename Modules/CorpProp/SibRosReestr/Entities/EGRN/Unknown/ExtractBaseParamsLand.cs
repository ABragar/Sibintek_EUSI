...
{
    /// <summary>
    /// Выписка об основных характеристиках и зарегистрированных правах на объект недвижимости (земельный участок)
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.7.2102.0")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlRootAttribute("extract_base_params_land", Namespace = "", IsNullable = false)]
    public class ExtractBaseParamsLand
    {
        public ExtractBaseParamsLand()
        {
            Right_records = new List<RightRecordsBaseParamsRight_record>();
            Restrict_records = new List<RestrictRecordLandType>();
        ...
        public LandRecordBaseParams Land_record { get; set; }
        /// <summary>
        ...
        [System.Xml.Serialization.XmlArrayItem("restrict_record", Type = typeof(RestrictRecordLandType), IsNullable = false)]
        public List<RestrictRecordLandType> Restrict_records { get; set; }
        /// <summary>
