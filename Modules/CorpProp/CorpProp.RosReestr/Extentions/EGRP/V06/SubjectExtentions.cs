...
namespace CorpProp.RosReestr.Extentions.EGRP.V06
{
    public static class SubjectExtentions
    {
        ...
        public static SubjectRecord FindOrCreateSubject(IUnitOfWork uow, SibRosReestr.EGRP.V06.ExtractSubj.TPerson obj)
        {
        ...
        public static SubjectRecord FindOrCreateSubject(IUnitOfWork uow, SibRosReestr.EGRP.V06.ExtractSubj.TOrganization obj)
        {
            SubjectRecord sr = null;
        ...
        private static SubjectRecord CreateSubject(IUnitOfWork uow, SibRosReestr.EGRP.V06.ExtractSubj.TOrganization obj)
        {
            if (obj == null) return null;
            ...
            if (obj.ItemElementName == SibRosReestr.EGRP.V06.ExtractSubj.ItemChoiceType.INN)
                sr.Inn = obj.Item;
        ...
        private static SubjectRecord CreateSubject(IUnitOfWork uow, SibRosReestr.EGRP.V06.ExtractSubj.TPerson obj)
        {
            if (obj == null) return null;
        ...
        public static SubjectRecord FindOrCreateSubject(IUnitOfWork uow, SibRosReestr.EGRP.V06.ExtractSubj.TGovernance obj)
        {
            SubjectRecord sr = null;
        ...
        private static SubjectRecord CreateSubject(IUnitOfWork uow, SibRosReestr.EGRP.V06.ExtractSubj.TGovernance obj)
        {
            if (obj == null) return null;
