...
namespace CorpProp.RosReestr.Extentions.EGRP.V04
{
    ...
    public static class ObjectExtentions
    {
            ...
            )
        {
            ...
            if (obj.ItemElementName == SibRosReestr.EGRP.V04.ExtractSubj.ItemChoiceType1.ConditionalNumber)
        ...
        private static void SetArea(
            this ObjectRecord oni
          , SibRosReestr.EGRP.V04.ExtractSubj.TArea obj
           )
        {
            if (obj == null) return;
            oni.Area = obj.Area;
        ...
        private static void SetAddress(
          this ObjectRecord oni
        , SibRosReestr.EGRP.V04.ExtractSubj.TAddress obj
         )
        {
            if (obj == null) return;
            oni.Address = obj.Content;
            oni.ID_Address = obj.ID_Address;
            if (obj.Item != null && obj.Item is SibRosReestr.EGRP.V04.ExtractSubj.TAddressRegion)
            {
                oni.RegionCode = ImportHelper.GetCodeEnum(((SibRosReestr.EGRP.V04.ExtractSubj.TAddressRegion)(obj.Item)).Code);
                oni.RegionName = ((SibRosReestr.EGRP.V04.ExtractSubj.TAddressRegion)(obj.Item)).Name;
            }
