...
namespace CorpProp.RosReestr.Extentions.EGRP.V04
{
    ...
    public static class RestrictExtentions
    {
        ...
        public static void Import(
           ...
           , SibRosReestr.EGRP.V04.ExtractSubj.TRightSubjEncumbrance obj
        ...
        private static void SetOwnersV04(
             this RestrictRecord rr
           , List<object> objs
          )
        {
            ...
            {
                if (item is SibRosReestr.EGRP.V04.ExtractSubj.TSubject)
                {
                    if (!String.IsNullOrEmpty(rr.Owner))
                        rr.Owner += "; ";
                    rr.Owner += ImportHelper.GetSubjectInfo(((SibRosReestr.EGRP.V04.ExtractSubj.TSubject)item));
                }
