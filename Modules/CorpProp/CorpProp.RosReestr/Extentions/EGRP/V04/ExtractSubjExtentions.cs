...
namespace CorpProp.RosReestr.Extentions.EGRP.V04
{
    ...
    public static class ExtractSubjExtentions
    {
        ...
        public static void ImportV04(
              this ExtractSubj extract
            , SibRosReestr.EGRP.V04.ExtractSubj.Extract ext
        ...
        private static void SetServisInfo(
            this ExtractSubj extract
            , SibRosReestr.EGRP.V04.ExtractSubj.TServisInf info
        )
        {
            if (info == null) return;
        ...
        private static void SetSender(
            this ExtractSubj extract
            , SibRosReestr.EGRP.V04.ExtractSubj.TServisInfSender sender
        )
        {
        ...
        private static void SetRecipient(
            this ExtractSubj extract
            , SibRosReestr.EGRP.V04.ExtractSubj.TServisInfRecipient recipient
        )
        {
        ...
        private static void SetDeclarAttribute(
           this ExtractSubj extract
           , SibRosReestr.EGRP.V04.ExtractSubj.TExtrAttribut obj
        )
        {
            if (obj == null) return;
        ...
        private static void SetExtractPeriod(
             this ExtractSubj extract
           , SibRosReestr.EGRP.V04.ExtractSubj.ExtractReestrExtractExtractPeriod obj
            )
        {
            if (obj == null) return;
        ...
        private static void CreateNotice(
              this ExtractSubj extract
           , SibRosReestr.EGRP.V04.ExtractSubj.TNoticeSubj obj
           , IUnitOfWork uow
            )
        {
            ...
            foreach (var item in obj.NoticeSubj)
            {
                ...
                if (item.Item != null)
                {
                    if (item.Item is SibRosReestr.EGRP.V04.ExtractSubj.TSubject)
        ...
        private static void CreateRefusal(
            this ExtractSubj extract
         , SibRosReestr.EGRP.V04.ExtractSubj.TRefusalSubj obj
         , IUnitOfWork uow
          )
        {
        ...
        private static void SetSubject(
              this ExtractSubj extract
         , SibRosReestr.EGRP.V04.ExtractSubj.TSubject obj
         , IUnitOfWork uow
        )
        {
       ...
       )
        {
            if (obj == null || obj.Item == null) return;
            var item = obj.Item;
            if (item is SibRosReestr.EGRP.V04.ExtractSubj.TOrganization)
            {
                SibRosReestr.EGRP.V04.ExtractSubj.TOrganization org =
                    item as SibRosReestr.EGRP.V04.ExtractSubj.TOrganization;
                if (org == null) return;
                extract.SubjectRecord = SubjectExtentions.FindOrCreateSubject(uow, org);
            }
            if (item is SibRosReestr.EGRP.V04.ExtractSubj.TPerson)
            {
                SibRosReestr.EGRP.V04.ExtractSubj.TPerson pers =
                    item as SibRosReestr.EGRP.V04.ExtractSubj.TPerson;
                if (pers == null) return;
         ...
         )
        {
            ...
            if (extract.Society != null)
            {
                extract.SubjectINN = extract.Society.INN;
                extract.SubjectName = extract.Society.ShortName;
            }
        }
        ...
        private static void CreateObjects(
              this ExtractSubj extract
            , List<SibRosReestr.EGRP.V04.ExtractSubj.ExtractReestrExtractExtractSubjectRightsExtractSubjObjectRight> objs
            , SubjectRecord sr
            , ref ImportHolder holder
         )
        {
        ...
        private static ObjectRecord CreateObject(
             this ExtractSubj extract
            , SibRosReestr.EGRP.V04.ExtractSubj.TObject obj
            , ref ImportHolder holder
           )
        {
            if (obj == null) return null;
        ...
        private static void CreateEncumbrances(
            ...
            , RightRecord rr
            , ObjectRecord oni
            , List<SibRosReestr.EGRP.V04.ExtractSubj.TRightSubjEncumbrance> objs
            , ref ImportHolder holder
           )
        {
