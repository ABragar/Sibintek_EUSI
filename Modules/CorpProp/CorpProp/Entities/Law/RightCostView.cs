...
namespace CorpProp.Entities.Law
{
    ...
    /// <summary>
    /// Предоставляет сведения о стоимости права на кадастровый объект.
    /// </summary>
    /// <remarks>
    /// Используется в отчете - стоимость права по данным БУ.
    /// </remarks>

    [EnableFullTextSearch]
    public class RightCostView : TypeObject
    {
        ...
        [ListView(Hidden = true)]
        [DetailView(Name = "Числитель/Знаменатель доли", TabName = TabName2, Visible = false, Order = 27)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        /// </summary>
        [ListView(Order = 4)]
        [DetailView(Name = "Дата гос.регистрации", TabName = TabName2, Order = 30)]
        ...
        [ListView(Order = 3)]
        [FullTextSearchProperty]
        [DetailView(Name = "Номер гос. регистрации", TabName = TabName2, Order = 31)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        /// </summary>       
        [DetailView(Name = "Тип записи о регистрации", TabName = TabName2, Order = 32)]
        public RightType RightType { get; set; }

        [ListView(Order = 6)]
        [DetailView(Name = "Дата гос.регистрации прекращения права", TabName = TabName2, Order = 33)]
        public DateTime? RegDateEnd { get; set; }

        [FullTextSearchProperty]
        [ListView]       
        [DetailView(Name = "Первоначальная стоимость", TabName = TabName2, Order = 33)]
        public decimal? InitialCost { get; set; }
        [FullTextSearchProperty]
        [ListView]
        [DetailView(Name = "Остаточная стоимость", TabName = TabName2, Order = 33)]
        public decimal? ResidualCost { get; set; }
        [FullTextSearchProperty]
        [ListView]
        [DetailView(Name = "Начисленная амортизация", TabName = TabName2, Order = 33)]
        public decimal? DepreciationCost { get; set; }


        [DetailView(Name = "Сведения об изъятии", TabName = TabName2, Order = 34
        ...
        [ListView(Hidden = true)]
        [PropertyDataType(PropertyDataType.Text)]
        [DetailView(Name = "Форма собственности", TabName = TabName2, Order = 35)]
        public string OwnershipType { get; set; }


        [ListView(Hidden = true)]
        [DetailView(Name = "Вид основания для правообладания", TabName = TabName2, Order = 35)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        /// </summary>
        [ListView(Hidden = true)]
        [DetailView(Name = "Вид, номер, дата", TabName = TabName1, Visible = false, Order = 37)]
        [PropertyDataType(PropertyDataType.Text)]
