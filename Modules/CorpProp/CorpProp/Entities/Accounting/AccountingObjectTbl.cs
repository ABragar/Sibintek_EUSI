...
namespace CorpProp.Entities.Accounting
{
    ...
    public class AccountingObjectTbl : TypeObject
    {
        ...
        /// </summary>
        public AccountingObjectTbl() : base()
        {
        }
        ...
        /// </summary>
        [DetailView(Name = "Комментарий", TabName = CaptionHelper.DefaultTabName)]
        [ListView(Hidden = true)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        public CorpProp.Entities.Estate.Estate Estate { get; set; }
        ...
        [DetailView("Код ОКОФ", TabName = TabName1, Order = 21)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        [DetailView("Код ОКОФ 2", TabName = TabName1, Order = 24)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        [DetailView("Класс ОКОФ", TabName = TabName1, Order = 20)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        [DetailView("Класс ОКОФ 2", TabName = TabName1, Order = 23)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        [DetailView("Код ОКТМО", TabName = TabName1, Order = 26)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        [DetailView("ОКТМО", TabName = TabName1, Order = 27)]
        [PropertyDataType(PropertyDataType.Text)]
        ...
        public StateObjectRSBU StateObjectRSBU { get; set; }
        ...
        public TaxFreeLand TaxFreeLand { get; set; }
        ...
        public TaxFreeTS TaxFreeTS { get; set; }
        ...
        public TaxLower TaxLower { get; set; }
        ...
        [ListView("Код налоговой льготы в виде уменьшения суммы налога", Visible = false)]
        [DetailView("Код налоговой льготы в виде уменьшения суммы налога", Visible = false)]
        public TaxLowerLand TaxLowerLand { get; set; }
        ...
        public TaxLowerTS TaxLowerTS { get; set; }
        ...
        public TaxRateLowerLand TaxRateLowerLand { get; set; }
        ...
        public TaxRateLowerTS TaxRateLowerTS { get; set; }
