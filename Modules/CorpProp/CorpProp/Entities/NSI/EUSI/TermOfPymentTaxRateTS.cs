...
{
    /// <summary>
    /// Представляет справочник "Срок уплаты авансовых платежей и налога (Транспорт)"
    /// </summary>
    [EnableFullTextSearch]
    public class TermOfPymentTaxRateTS : DictObject
    {
