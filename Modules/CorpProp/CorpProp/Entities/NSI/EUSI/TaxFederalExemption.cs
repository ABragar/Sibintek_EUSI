...
{
    /// <summary>
    /// Представляет справочник "Федеральные льготы Имущество".
    /// </summary>
    [EnableFullTextSearch]
    public class TaxFederalExemption : DictObject
    {
        ...
        [DetailView(Name = "Налоговая льгота Имущество", ReadOnly = true)]
        [ListView]
