...
{
    /// <summary>
    /// Предоставляет данные и методы сервиса записи о транспортном средстве.
    /// </summary>
    public interface IVehicleService : Base.ITypeObjectService<Vehicle>
    {

    }

    /// <summary>
    /// Представляет сервис записи транспортного средства.
    /// </summary>
    public class VehicleService : BaseEstateService<Vehicle>, IVehicleService
    {
        private readonly ILogService _logger;
        /// <summary>
        /// Инициализирует новый экземпляр класса VehicleService.
        /// </summary>
        /// <param name="facade"></param>
        public VehicleService(IBaseObjectServiceFacade facade, INonCoreAssetService nonCoreAssetService, IAccountingObjectService osService, ILogService logger) :
        ...
        public override Vehicle Create(IUnitOfWork unitOfWork, Vehicle obj)
        {
        ...
        /// <returns></returns>
        protected override IObjectSaver<Vehicle> GetForSave(IUnitOfWork unitOfWork,
            IObjectSaver<Vehicle> objectSaver)
        {
