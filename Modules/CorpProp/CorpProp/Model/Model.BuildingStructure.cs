...
{
    /// <summary>
    /// Предоставляет методы конфигурации модели здания.
    /// </summary>
    public static class BuildingStructureModel
    {
        private const string BuildingStructure_AdditionalFeatures = nameof(BuildingStructure_AdditionalFeatures);

        /// <summary>
        /// Создает конфигурацию модели здания по умолчанию.
        /// </summary>
        /// <param name="context"></param>
        /// <returns></returns>
        public static void CreateModelConfig(this IInitializerContext context)
        {
            context.CreateVmConfig<AdditionalFeatures>(BuildingStructure_AdditionalFeatures);

            context.CreateVmConfig<BuildingStructure>()
                   .Service<IBuildingStructureService>()
                   .Title("Здание/Сооружение")
                   .DetailView_Default()
                   .ListView_Default()
                   .LookupProperty(x => x.Text(c => c.Name));

            context.CreateVmConfig<BuildingStructure>("BuildingStructureMenuList")
                .Service<IBuildingStructureService>()
                .Title("Здание/Сооружение")
                .DetailView_Default()
                .ListView_BuildingStructureMenuList()
                .LookupProperty(x => x.Text(c => c.Name));
        }
        ...
        /// <returns></returns>
        public static ViewModelConfigBuilder<BuildingStructure> DetailView_Default(this ViewModelConfigBuilder<BuildingStructure> conf)
        {
               ...
               .Editors(editors => editors
                   //Доп. характеристики
                   .AddPartialEditor(BuildingStructure_AdditionalFeatures, nameof(IHasAdditionalFeature.AdditionalFeaturesID), nameof(IBaseObject.ID),
                  ...
                  .Add(ed => ed.Name, ac => ac.Title("Наименование БУ").TabName(EstateTabs.GeneralInfo).Visible(true).Order(41))
                  .Add(ed => ed.NameByRight, ac => ac.Title("Наименование по данным ЕГРН").TabName(EstateTabs.GeneralInfo).Visible(true).Order(50))
                  .Add(ed => ed.Address, ac => ac.Title("Адрес (местоположение)").TabName(EstateTabs.GeneralInfo).Visible(true).Order(60))
                  .Add(ed => ed.SpecialMarks, ac => ac.Title("Особые отметки").TabName(EstateTabs.GeneralInfo).Visible(true).Order(70))
                  .Add(ed => ed.RegDate, ac => ac.Title("Дата постановки на учет/регистрации").TabName(EstateTabs.GeneralInfo).Visible(true).Order(80))
                  .Add(ed => ed.DeRegDate, ac => ac.Title("Дата снятия с учета/регистрации").TabName(EstateTabs.GeneralInfo).Visible(true).Order(90))
                  .Add(ed => ed.OldRegNumbers, ac => ac.Title("Ранее присвоенные номера").TabName(EstateTabs.GeneralInfo).Visible(true).Order(100))
                  .Add(ed => ed.CadastralNumber, ac => ac.Title("Кадастровый номер").TabName(EstateTabs.GeneralInfo).IsRequired(true).Visible(true).Order(110))
                  .Add(ed => ed.BlocksNumber, ac => ac.Title("Номер кадастрового квартала").TabName(EstateTabs.GeneralInfo).Visible(true).Order(120))
                  //.Add(ed => ed.ClassFixedAsset, ac => ac.Title("Класс БУ").TabName(EstateTabs.GeneralInfo).Visible(true).Order(130))
                  .Add(ed => ed.Bush, ac => ac.Title("Куст").TabName(EstateTabs.GeneralInfo).Visible(true).Order(140))
                  .Add(ed => ed.Well, ac => ac.Title("Скважина").TabName(EstateTabs.GeneralInfo).Visible(true).Order(150))
                  .Add(ed => ed.CadastralNumberLand, ac => ac.Title("Кадастровый номер ЗУ").TabName(EstateTabs.GeneralInfo)
                  .Description("ЗУ, на котором расположен объект НИ").Visible(true).Order(160))
                   ...
                   //.Add(ed => ed.Name, ac => ac.Title("Наименование").TabName(EstateTabs.Characteristics3).Visible(true).Order(1))
                   .Add(ed => ed.RealEstatePurpose, ac => ac.Title("Назначение здания/сооружения").TabName(EstateTabs.Characteristics3).Visible(true).Order(11))
                   .Add(ed => ed.RealEstateKinds, ac => ac.Title("Вид(ы) разрешенного использования").TabName(EstateTabs.Characteristics3).Visible(true).Order(12))
                   .Add(ed => ed.YearComplete, ac => ac.Title("Год завершения строительства").TabName(EstateTabs.Characteristics3).Visible(true).Order(13))
                   .Add(ed => ed.YearCommissionings, ac => ac.Title("Год ввода в эксплуатацию").TabName(EstateTabs.Characteristics3)
                   .Description("Год ввода в эксплуатацию по завершении строительства").Visible(true).Order(14))
                   .Add(ed => ed.CadastralValue, ac => ac.Title("Кадастровая стоимость").TabName(EstateTabs.Characteristics3).Visible(true).Order(15))

                   //сведения о частях
                   .AddOneToManyAssociation<CadastralPart>("BuildingStructure_CadastralParts",
                         ...
                         .Filter((uofw, q, id, oid) => q.Where(w => w.CadastralID == id)))
                    .Add(ed => ed.RealEstateKind, ac => ac.Title("Вид объекта недвижимости").TabName(EstateTabs.Characteristics3).Visible(true).Order(16))

                   //координаты
                   .AddOneToManyAssociation<Coordinate>("BuildingStructure_Coordinates",
                         ...
                         .Filter((uofw, q, id, oid) => q.Where(w => w.CadastralID == id)).Visible(true).Order(17))
                  ...
                  .Add(ed => ed.AddressID, ac => ac.Title("Идентификатор адреса").TabName(EstateTabs.Address9).Visible(true).Order(1))
                  ...
                  .Add(ed => ed.District, ac => ac.Title("Район").TabName(EstateTabs.Address9).Visible(true).Order(6))
                  .Add(ed => ed.City, ac => ac.Title("Город").TabName(EstateTabs.Address9).Visible(true).Order(7))
                  .Add(ed => ed.Locality, ac => ac.Title("Поселок").TabName(EstateTabs.Address9).Visible(true).Order(8))
                  .Add(ed => ed.Street, ac => ac.Title("Улица").TabName(EstateTabs.Address9).Visible(true).Order(9))
                  .Add(ed => ed.House, ac => ac.Title("Дом").TabName(EstateTabs.Address9).Visible(true).Order(10))
                  ...
                  .AddOneToManyAssociation<Right>("BuildingStructure_Rights",
                         ...
                         .Filter((uofw, q, id, oid) => q.Where(w => w.EstateID == id)).Visible(true).Order(11))


                   //.AddOneToManyAssociation<FileCard>("BuildingStructure_RightDocs",
                   ...
                   .AddOneToManyAssociation<Encumbrance>("BuildingStructure_Encumbrances",
                   ...
                   .AddOneToManyAssociation<AccountingObject>("BuildingStructure_AccountingObjects",
                        editor => editor
                ...
                .DefaultSettings((uow, r, commonEditorViewModel) =>
                {
                  ...
                  .AddManyToMany("BuildingStructure_FileCards"
                  , typeof(FileCardAndEstate)
                  , typeof(IManyToManyLeftAssociation<>)
                  , ManyToManyAssociationType.Rigth
                  , y => y.TabName(EstateTabs.Links14).Visible(true).Order(5))

                  
                  //выписки                 
                  .AddManyToMany("BuildingStructure_Extracts"
        ...
        /// <param name="conf"></param>
        /// <returns></returns>
        public static ViewModelConfigBuilder<BuildingStructure> ListView_Default(this ViewModelConfigBuilder<BuildingStructure> conf)
        {
            return
                conf.ListView(x => x
                .Title("Здания/Сооружения")
                ...
                .Columns(col => col
                    ...
                    //.Add(c => c.ClassFixedAsset, ac => ac.Title("Класс БУ").Visible(true).Order(110))
                    
                    
                    //.Add(c => c.DateOfReceipt, ac => ac.Title("Дата оприходования").Visible(true).Order(130))
                    //.Add(c => c.EstateType, ac => ac.Title("Класс КС").Visible(true).Order(140))
                    //.Add(c => c.OKTMORegion, ac => ac.Title("Регион по ОКТМО").Visible(true).Order(150))
                    .Add(c => c.RighHolder, ac => ac.Title("Правообладатель").Visible(true).Order(160))
                    .Add(c => c.SibRegion, ac => ac.Title("Регион").Visible(true).Order(170))
                    .Add(c => c.RighKindAndShare, ac => ac.Title("Вид права, доля в праве").Visible(true).Order(180))
                    .Add(c => c.RightRegDate, ac => ac.Title("Дата гос.регистрации").Visible(true).Order(190))
                    .Add(c => c.RightRegNumber, ac => ac.Title("Номер гос.регистрации").Visible(true).Order(200))
                    ...
                    .Add(c => c.DealProps, ac => ac.Title("Реквизиты договора").Visible(true).Order(210))
                    ...
                    .ColumnsFrom<AdditionalFeatures>(BuildingStructure_AdditionalFeatures, nameof(IHasAdditionalFeature.AdditionalFeaturesID), nameof(IBaseObject.ID))
                );
        }
        ...
        /// <param name="conf"></param>
        /// <returns></returns>
        public static ViewModelConfigBuilder<BuildingStructure> ListView_BuildingStructureMenuList(this ViewModelConfigBuilder<BuildingStructure> conf)
        {
            return
