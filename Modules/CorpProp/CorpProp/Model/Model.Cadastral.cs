...
{
    /// <summary>
    /// Предоставляет методы конфигурации модели кадастрового объекта.
    /// </summary>
    public static class CadastralModel
    {
        private const string Cadastral_AdditionalFeatures = nameof(Cadastral_AdditionalFeatures);

        /// <summary>
        /// Создает конфигурацию модели КО по умолчанию.
        /// </summary>
        /// <param name="context"></param>
        /// <returns></returns>
        public static void CreateModelConfig(this IInitializerContext context)
        {
            context.CreateVmConfig<AdditionalFeatures>(Cadastral_AdditionalFeatures);

            context.CreateVmConfig<Cadastral>()
                   .Service<ICadastralService>()
                   .Title("Кадастровый объект")
                   .DetailView_Default()
                   .ListView_Default()
                   .LookupProperty(x => x.Text(c => c.Name));

            context.CreateVmConfig<Cadastral>("CadastralMenuList")
                     .Service<ICadastralService>()
                     .Title("Кадастровый объект")
                     .DetailView_Default()
                     .ListView_CadastralMenuList()
                     .LookupProperty(x => x.Text(c => c.Name));
        ...
        /// <returns></returns>
        public static ViewModelConfigBuilder<Cadastral> DetailView_Default(this ViewModelConfigBuilder<Cadastral> conf)
        {
           ...
           .Editors(editors => editors
                //Доп. характеристики
                .AddPartialEditor(Cadastral_AdditionalFeatures, nameof(IHasAdditionalFeature.AdditionalFeaturesID), nameof(IBaseObject.ID),
                ...
                .Add(ed => ed.Address, ac => ac.Title("Адрес (местоположение)").TabName(EstateTabs.GeneralInfo).Visible(false).Order(40))
              ...
              .Add(ed => ed.IsTaxCadastral, ac => ac.Title("Налог с кад.стоимости").TabName(EstateTabs.GeneralInfo).Visible(true).Order(150))
               ...
               .Description("Год ввода в эксплуатацию по завершении строительства").Visible(true).Order(13))
               .Add(ed => ed.CadastralValue, ac => ac.Title("Кадастровая стоимость").TabName(EstateTabs.Characteristics3).Visible(true).Order(14))

               //сведения о частях
               .AddOneToManyAssociation<CadastralPart>("Cadastral_CadastralParts",
                     ...
                     .Title("Сведения о частях")
                         ...
                         .Filter((uofw, q, id, oid) => q.Where(w => w.CadastralID == id)).Visible(true).Order(15))
                .Add(ed => ed.RealEstateKind, ac => ac.Title("Вид объекта недвижимости").TabName(EstateTabs.Characteristics3).Visible(true).Order(16))

               //координаты
               .AddOneToManyAssociation<Coordinate>("Cadastral_Coordinates",
              ...
              //.Add(ed => ed.AccountingName, ac => ac.Title("Наименование").TabName(EstateTabs.AccountingDt5).Visible(true).Order(7))
              ...
              .AddOneToManyAssociation<Right>("Cadastral_Rights",
                ...
                //.AddOneToManyAssociation<FileCard>("CadastralObject_RightDocs",
               ...
               .AddManyToManyLeftAssociation<CadastralAndExtract>("Cadastral_Extracts", y=>y.TabName(EstateTabs.Extract15).Visible(true).Order(1))
                

               .AddOneToManyAssociation<AccountingObject>("Cadastral_AccountingObjects",
                        editor => editor
               ...
               .Config.DetailView.Editors
                  .AddManyToMany("Cadastral_FileCards"
        ...
        /// <param name="conf"></param>
        /// <returns></returns>
        public static ViewModelConfigBuilder<Cadastral> ListView_Default(this ViewModelConfigBuilder<Cadastral> conf)
        {
            return
                conf.ListView(x => x
                .Title("Кадастровые объекты")
                .Toolbar(factory => factory.Add("GetEstateToolBar", "AdditionalProperty"))
                .DataSource(ds=>ds.Filter(f=> f.Fake == null))
                .Columns(col => col
                    ...
                    .Add(c => c.InventoryNumber, ac => ac.Title("Инвентарный номер в старой БУС").Visible(true).Order(120))
                    ...
                    .ColumnsFrom<AdditionalFeatures>(Cadastral_AdditionalFeatures, nameof(IHasAdditionalFeature.AdditionalFeaturesID), nameof(IBaseObject.ID))
                );
        ...
        /// <param name="conf"></param>
        /// <returns></returns>
        public static ViewModelConfigBuilder<Cadastral> ListView_CadastralMenuList(this ViewModelConfigBuilder<Cadastral> conf)
        {
            return
