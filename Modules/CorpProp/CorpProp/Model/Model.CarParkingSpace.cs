...
{
    /// <summary>
    /// Предоставляет методы конфигурации модели машино-места.
    /// </summary>
    public static class CarParkingSpaceModel
    {
        private const string CarParkingSpace_AdditionalFeatures = nameof(CarParkingSpace_AdditionalFeatures);

        /// <summary>
        /// Создает конфигурацию модели машино-места по умолчанию.
        /// </summary>
        /// <param name="context"></param>
        /// <returns></returns>
        public static void CreateModelConfig(this IInitializerContext context)
        { 
            context.CreateVmConfig<AdditionalFeatures>(CarParkingSpace_AdditionalFeatures);

            context.CreateVmConfig<CarParkingSpace>()
                   .Service<ICarParkingSpaceService>()
                   .Title("Машино-место")
                   .DetailView_Default()
                   .ListView_Default()
                   .LookupProperty(x => x.Text(c => c.Name));

            context.CreateVmConfig<CarParkingSpace>("CarParkingSpaceMenuList")
                     .Service<ICarParkingSpaceService>()
                     .Title("Машино-место")
                     .DetailView_Default()
                     .ListView_CarParkingSpaceMenuList()
                     .LookupProperty(x => x.Text(c => c.Name));

        }

        /// <summary>
        /// Конфигурация карточки машино-места по умолчанию.
        /// </summary>
        /// <param name="conf"></param>
        /// <returns></returns>
        public static ViewModelConfigBuilder<CarParkingSpace> DetailView_Default(this ViewModelConfigBuilder<CarParkingSpace> conf)
        {
           ...
           .Editors(editors => editors
              //Доп. характеристики
              .AddPartialEditor(CarParkingSpace_AdditionalFeatures, nameof(IHasAdditionalFeature.AdditionalFeaturesID), nameof(IBaseObject.ID),
              ...
              .Add(ed => ed.IsPropertyComplex, ac => ac.Title("ОИ как имущественный комплекс").TabName(EstateTabs.GeneralInfo).Visible(true).Group("Признаки").GroupOrder(1).Order(30))
                  .Add(ed => ed.Parent, ac => ac.Title("Вышестоящий объект имущества").TabName(EstateTabs.GeneralInfo).Visible(true).Order(40))
              .Add(ed => ed.Address, ac => ac.Title("Адрес (местоположение)").TabName(EstateTabs.GeneralInfo).Visible(true).Order(50))
              .Add(ed => ed.SpecialMarks, ac => ac.Title("Особые отметки").TabName(EstateTabs.GeneralInfo).Visible(true).Order(60))
              .Add(ed => ed.RegDate, ac => ac.Title("Дата постановки на учет/регистрации").TabName(EstateTabs.GeneralInfo).Visible(true).Order(70))
              .Add(ed => ed.DeRegDate, ac => ac.Title("Дата снятия с учета/регистрации").TabName(EstateTabs.GeneralInfo).Visible(true).Order(80))
              .Add(ed => ed.OldRegNumbers, ac => ac.Title("Ранее присвоенные номера").TabName(EstateTabs.GeneralInfo).Visible(true).Order(90))
              .Add(ed => ed.CadastralNumber, ac => ac.Title("Кадастровый номер").TabName(EstateTabs.GeneralInfo).IsRequired(true).Visible(true).Order(100))
              .Add(ed => ed.BlocksNumber, ac => ac.Title("Номер кадастрового квартала").TabName(EstateTabs.GeneralInfo).Visible(true).Order(110))
              //.Add(ed => ed.ClassFixedAsset, ac => ac.Title("Класс БУ").TabName(EstateTabs.GeneralInfo).Visible(true).Order(120))
              //.Add(ed => ed.Bush, ac => ac.Title("Куст").TabName(EstateTabs.GeneralInfo).Visible(true).Order(130))
              //.Add(ed => ed.Well, ac => ac.Title("Скважина").TabName(EstateTabs.GeneralInfo).Visible(true).Order(140))
              .Add(ed => ed.CadastralNumberLand, ac => ac.Title("Кадастровый номер ЗУ").TabName(EstateTabs.GeneralInfo)
              .Description("ЗУ, на котором расположен объект НИ").Visible(true).Order(150))
               ...
               //сведения о частях
               .AddOneToManyAssociation<CadastralPart>("CarParkingSpace_CadastralParts",
                     ...
                     .Title("Сведения о частях")
                         ...
                         .Filter((uofw, q, id, oid) => q.Where(w => w.CadastralID == id)).Visible(true).Order(18))
                .Add(ed => ed.RealEstateKind, ac => ac.Title("Вид объекта недвижимости").TabName(EstateTabs.Characteristics3).Visible(true).Order(17))

               //координаты
               .AddOneToManyAssociation<Coordinate>("CarParkingSpace_Coordinates",
              ...
              //данные БУ
              .Add(ed => ed.IsRealEstate, ac => ac.Title("Признак недвижимого имущества").TabName(EstateTabs.AccountingDt5).Visible(true).Order(10))
              //.Add(ed => ed.ExternalID, ac => ac.Title("Внутренний №").TabName(EstateTabs.AccountingDt5).Visible(true).Order(20))
              .Add(ed => ed.InventoryNumber, ac => ac.Title("Инвентарный номер").TabName(EstateTabs.AccountingDt5).Visible(true).Order(30))
              .Add(ed => ed.InventoryNumber2, ac => ac.Title("Инвентарный номер в старой БУС").TabName(EstateTabs.AccountingDt5).Visible(true).Order(40))
              .Add(ed => ed.Owner, ac => ac.Title("Балансодержатель").TabName(EstateTabs.AccountingDt5).Visible(true).IsReadOnly(true).Order(50))
              .Add(ed => ed.MainOwner, ac => ac.Title("Собственник").TabName(EstateTabs.AccountingDt5).Visible(true).IsReadOnly(true).Order(60))
              .Add(ed => ed.WhoUse, ac => ac.Title("Пользователь").TabName(EstateTabs.AccountingDt5).Visible(true).IsReadOnly(true).Order(70))
              ////.Add(ed => ed.AccountNumber, ac => ac.Title("Счет").TabName(EstateTabs.AccountingDt5).Visible(true).Order(70))
              //.Add(ed => ed.ClassFixedAsset, ac => ac.Title("Класс БУ").TabName(EstateTabs.AccountingDt5).Visible(true).Order(80))
              .Add(ed => ed.Name, ac => ac.Title("Наименование БУ").TabName(EstateTabs.AccountingDt5).Visible(true).Order(90))
              .Add(ed => ed.Description, ac => ac.Title("Описание").TabName(EstateTabs.AccountingDt5).Visible(true).Order(100))
              //.Add(ed => ed.BusinessArea, ac => ac.Title("Обособленное подразделение/БС").TabName(EstateTabs.AccountingDt5).Visible(true).Order(100))
              .Add(ed => ed.DealProps, ac => ac.Title("Реквизиты договора").TabName(EstateTabs.AccountingDt5).Visible(true).IsReadOnly(true).Order(120))


              //.Add(ed => ed.MOL, ac => ac.Title("МОЛ").TabName(EstateTabs.AccountingDt5).Visible(true).Order(120))
              //.Add(ed => ed.DateOfReceipt, ac => ac.Title("Дата оприходования").TabName(EstateTabs.AccountingDt5).Visible(true).Order(130))
              //.Add(ed => ed.ReceiptReason, ac => ac.Title("Причина поступления").TabName(EstateTabs.AccountingDt5).Visible(true).Order(140))
              //.Add(ed => ed.LeavingDate, ac => ac.Title("Дата списания").TabName(EstateTabs.AccountingDt5).Visible(true).Order(150))
              //.Add(ed => ed.LeavingReason, ac => ac.Title("Причина выбытия").TabName(EstateTabs.AccountingDt5).Visible(true).Order(160))
              ...
              .AddOneToManyAssociation<Right>("CarParkingSpace_Rights",
               ...
               //.AddOneToManyAssociation<FileCard>("CarParkingSpace_RightDocs",
               ...
               .AddOneToManyAssociation<Encumbrance>("CarParkingSpace_Encumbrances",
               ...
               .Add(ed => ed.Fake, ac => ac.TabName(EstateTabs.Links14).Visible(true).Order(2))
                ...
                .AddOneToManyAssociation<AccountingObject>("CarParkingSpace_AccountingObjects",
                        editor => editor
               ...
               .AddManyToMany("CarParkingSpace_FileCards"
                ...
                //выписки                 
               .AddManyToMany("CarParkingSpace_Extracts"
        ...
        /// <summary>
        /// Конфигурация реестра машино-мест по умолчанию.
        /// </summary>
        /// <param name="conf"></param>
        /// <returns></returns>
        public static ViewModelConfigBuilder<CarParkingSpace> ListView_Default(this ViewModelConfigBuilder<CarParkingSpace> conf)
        {
            return
                conf.ListView(x => x
                .Title("Машино-места")
                ...
                .Columns(col => col
                    ...
                    .ColumnsFrom<AdditionalFeatures>(CarParkingSpace_AdditionalFeatures, nameof(IHasAdditionalFeature.AdditionalFeaturesID), nameof(IBaseObject.ID))
                );

        }

        /// <summary>
        /// Конфигурация реестра машино-мест для мнемоники реестра, отображаемого при открытии пункта навигационного меню.
        /// </summary>
        /// <param name="conf"></param>
        /// <returns></returns>
        public static ViewModelConfigBuilder<CarParkingSpace> ListView_CarParkingSpaceMenuList(this ViewModelConfigBuilder<CarParkingSpace> conf)
        {
            return
