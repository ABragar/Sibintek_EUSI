...
{
    public class SeparLandAdditionals : BaseObject, IChildrenModel
    {
        private const string TabName = "[8]Дополнительные характеристики";
        ...
        [DetailView(Name = "Доп. характеристика 10 (дата)", Visible = false, TabName = TabName, Order = 201), ListView(Visible = false, Order = 249)]
