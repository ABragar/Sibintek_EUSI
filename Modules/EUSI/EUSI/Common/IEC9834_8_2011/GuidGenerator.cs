...
namespace EUSI.Common.IEC9834_8_2011
{
    /// <summary>
    ...
    public static class GuidGenerator
    {
        ...
        private static readonly DateTimeOffset GregorianCalendarStart = new DateTimeOffset(
                                                                                           1582,
                                                                                           10,
                                                                                           15,
                                                                                           0,
        ...
        public static byte[] GenerateNodeBytes(IPAddress ip)
        {
            ...
            if (bytes.Length < 6)
                throw new ArgumentOutOfRangeException(
                                                      "ip",
                                                      "The passed in IP address must contain at least 6 bytes.");
        ...
        public static GuidVersion GetUuidVersion(this Guid guid)
        {
            ...
            return (GuidGenerator.GuidVersion) ((bytes[VersionByte] & 0xFF) >> VersionByteShift);
        }
